...
{
    /// <summary>
    /// Represents an OSP object id
    /// </summary>
    public struct OspObjectId : IComparable<OspObjectId>, IEquatable<OspObjectId>, IConvertible
    {
        // private static fields
        private static readonly OspObjectId EmptyInstance = default;
        ...
        internal OspObjectId(byte[] bytes, int index)
        {
        ...
        public OspObjectId(string value)
        {
            if (value == null)
            {
            ...
            var bytes = Utils.ParseHexString(value);
            FromByteArray(bytes, 0, out _a, out _b, out _c);
        }

        private OspObjectId(int a, int b, int c)
        {
            _a = a;
            _b = b;
            _c = c;
        ...
        /// </summary>
        public static OspObjectId Empty
        {
        ...
        {
            get { return CommonConstants.UnixEpoch.AddSeconds((uint)Timestamp); }
        }
        ...
        public static bool operator <(OspObjectId lhs, OspObjectId rhs)
        {
        ...
        public static OspObjectId GenerateNewId()
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static OspObjectId GenerateNewId(DateTime timestamp)
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static OspObjectId GenerateNewId(int timestamp)
        {
        ...
        public static OspObjectId Parse(string s)
        {
            if (s == null)
            {
        ...
        public static bool TryParse(string s, out OspObjectId objectId)
        {
            ...
            if (s != null && s.Length == 24)
            {
                ...
                {
                    objectId = new OspObjectId(bytes);
                    return true;
                }
            }
        ...
        private static OspObjectId Create(int timestamp, long random, int increment)
        {
        ...
        {
            var secondsSinceEpoch = (long)Math.Floor((Utils.ToUniversalTime(timestamp) - CommonConstants.UnixEpoch).TotalSeconds);
        ...
        public int CompareTo(OspObjectId other)
        {
        ...
        /// <param name="rhs">The other ObjectId.</param>
        /// <returns>True if the two ObjectIds are equal.</returns>
        public bool Equals(OspObjectId rhs)
        {
            return
                _a == rhs._a &&
                _b == rhs._b &&
        ...
        {
            if (obj is OspObjectId)
            {
                return Equals((OspObjectId)obj);
            }
            else
            {
                return false;
        ...
        {
            var c = new char[24];
            c[0] = Utils.ToHexChar((_a >> 28) & 0x0f);
            c[1] = Utils.ToHexChar((_a >> 24) & 0x0f);
            c[2] = Utils.ToHexChar((_a >> 20) & 0x0f);
            c[3] = Utils.ToHexChar((_a >> 16) & 0x0f);
            c[4] = Utils.ToHexChar((_a >> 12) & 0x0f);
            c[5] = Utils.ToHexChar((_a >> 8) & 0x0f);
            c[6] = Utils.ToHexChar((_a >> 4) & 0x0f);
            c[7] = Utils.ToHexChar(_a & 0x0f);
            c[8] = Utils.ToHexChar((_b >> 28) & 0x0f);
            c[9] = Utils.ToHexChar((_b >> 24) & 0x0f);
            c[10] = Utils.ToHexChar((_b >> 20) & 0x0f);
            c[11] = Utils.ToHexChar((_b >> 16) & 0x0f);
            c[12] = Utils.ToHexChar((_b >> 12) & 0x0f);
            c[13] = Utils.ToHexChar((_b >> 8) & 0x0f);
            c[14] = Utils.ToHexChar((_b >> 4) & 0x0f);
            c[15] = Utils.ToHexChar(_b & 0x0f);
            c[16] = Utils.ToHexChar((_c >> 28) & 0x0f);
            c[17] = Utils.ToHexChar((_c >> 24) & 0x0f);
            c[18] = Utils.ToHexChar((_c >> 20) & 0x0f);
            c[19] = Utils.ToHexChar((_c >> 16) & 0x0f);
            c[20] = Utils.ToHexChar((_c >> 12) & 0x0f);
            c[21] = Utils.ToHexChar((_c >> 8) & 0x0f);
            c[22] = Utils.ToHexChar((_c >> 4) & 0x0f);
            c[23] = Utils.ToHexChar(_c & 0x0f);
            return new string(c);
        }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            switch (Type.GetTypeCode(conversionType))
            {
                ...
                case TypeCode.Object:
                    if (conversionType == typeof(object) || conversionType == typeof(OspObjectId))
                    {
                        return this;
                    }
                    break;
