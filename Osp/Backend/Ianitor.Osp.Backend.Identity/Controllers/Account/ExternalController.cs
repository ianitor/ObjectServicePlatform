...
namespace Ianitor.Osp.Backend.Identity.Controllers.Account
{
    [AllowAnonymous]
    public class ExternalController : Controller
    {
        ...
        private async Task<(OspUser user, string provider, string providerUserId, ICollection<Claim> claims)>
